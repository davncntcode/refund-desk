      ...
      <Table>
        <TableHeader>
          <TableRow className="hover:bg-transparent">
            <TableHead className="w-[128px]">Reference</TableHead>
        ...
        <TableBody>
          {rows.map((row) => (
            <TableRow key={row.id} className="hover:bg-muted/60">
              <TableCell className="numeric text-sm font-medium">
                <Link
                  href={`/refunds/${row.id}`}
              ...
              <TableCell className="numeric text-right text-sm font-semibold">
